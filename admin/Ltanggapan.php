          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
              	<a href="Ltanggapan_print.php" class="btn btn-outline-primary" data-toogle="tooltip" target="_blank">
...
<br>
            ...
            // $query_mysqli = mysqli_query($conn, "SELECT pengaduan.*,tanggapan. * FROM pengaduan INNER JOIN tanggapan ON tanggapan.id_pengaduan = pengaduan.id_pengaduan")or die(mysqli_error());
